"""
Einfache Tests für die Queen-Implementierung.
Validiert die Singleton-Funktionalität und grundlegende Methoden.
"""
...
from agents.base_agent import StreamChunk
...
async def test_queen_websocket_integration():
    ...
    def mock_handler(chunk: StreamChunk):
