"""
Streaming Chat Task für die Task Engine.
    ...
    async def execute(self, task_input: TaskInput) -> TaskOutput:
        ...
        try:
            ...
            if self.websocket_manager:
                ...
                await self.websocket_manager.send_personal_message(json.dumps(start_message), client_id)
                ...
                try:
                    ...
                    await self.websocket_manager.send_personal_message(json.dumps(end_message), client_id)
                    ...
                    await self.websocket_manager.send_personal_message(json.dumps(normal_message), client_id)
            ...
            self.logger.info(f"Streaming-Chat-Nachricht erfolgreich verarbeitet: {self.message_event.event_id}")
