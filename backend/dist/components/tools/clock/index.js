...
class ClockTool extends AbstractTool {
    constructor() {
        super(...arguments);
        this.name = "get_time";
        this.shortDescription = "Get the current server time in ISO format.";
        this.description = "Returns the current server time in ISO 8601 format (e.g., '2024-01-15T10:30:00.000Z'). This tool is useful when you need to know the current date and time, for example to schedule tasks, log timestamps, or provide time-sensitive information to users. The time is always returned in UTC timezone.";
        this.parameters = {
            type: "object",
            properties: {},
