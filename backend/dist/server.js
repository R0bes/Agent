...
import { llmComponent, personaComponent, guiSourceComponent, echoToolComponent, clockToolComponent, websiteSearchToolComponent, schedulerToolComponent, workerManagerToolComponent, guiControlToolComponent, toolboxComponent } from "./components";
...
export function sendAvatarCommand(command) {
    if (!app.io) {
...
(async () => {
    try {
        ...
        const eventTypes = ["message_created", "job_updated", "memory_updated", "gui_action"];
        ...
        try {
            ...
            if (toolExecutionWorker) {
                bullMQWorkerEngine.registerWorker(toolExecutionWorker);
